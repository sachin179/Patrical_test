...
{ 
 ...
 //Your code
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
			 ...
			 request.getParameter("itemCatogory"),
			request.getParameter("itemPrice"), 
			request.getParameter("itemDesc"),
			 request.getParameter("Brand"), 
			 request.getParameter("Color"),
			 request.getParameter("Size"),
			 request.getParameter("Meterial"),
			 request.getParameter("ItemLocation"),
			 request.getParameter("itemQuntity")); 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) 
			...
			{  
			 ...
			 paras.get("itemType").toString(), 
			 paras.get("itemCatogory").toString(), 
			paras.get("itemPrice").toString(), 
			paras.get("itemDesc").toString(),
			paras.get("Brand").toString(),
			paras.get("Color").toString(),
			paras.get("Size").toString(),
			paras.get("Meterial").toString(),
			paras.get("ItemLocation").toString(),
			paras.get("itemQuntity").toString());
			response.getWriter().write(output); 
